...
| matchupRating | FantasyPros Matchup-Rating (0–5), aus der manuell gepflegten `matchup-ratings.json` (siehe architecture.md) | Decimal | – | Optional (Datei fehlt/veraltet oder Spieler nicht enthalten) |
