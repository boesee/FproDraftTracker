...
| Attribute | Description | Data Type | Length/Precision | Validation Rules |
|-----------|-------------|-----------|-------------------|-------------------|
| rank | Wochenspezifischer Gesamt-Rang (PPR, Superflex/"OP") aus `rank.ECR.PPR.OP` der FantasyPros-API | Integer | – | Not Null, Min: 1, Max: 999 |
...
| position | Position kombiniert mit dem positionsspezifischen PPR-Rang (z. B. "RB81"), aus `position_id` + `rank.ECR.PPR[position_id]` | String | 10 | Not Null |
